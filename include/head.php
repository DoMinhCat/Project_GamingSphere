...
<head>
    ...
    <link rel="stylesheet" href=<?= ($this_page == 'index.php') ? '/PA/include/style.css' : '../include/style.css' ?>>
    ...
    <script src=<?= ($this_page == 'index.php') ? '/PA/include/night_mode.js' : '../include/night_mode.js' ?>></script>
    <title><?= $title ?></title>
</head>