...
// Notifications des demandes d'amis
$notificationCount = 0;
if (isset($_SESSION['user_id'])) {
    try {
        $stmt = $bdd->prepare("
            SELECT u.pseudo, r.date_début
            FROM relations r
...
if (isset($_SESSION['user_id'])) {
    try {
        $stmtMessages = $bdd->prepare("
            SELECT m.id, m.expediteur_id, m.date_envoi
            FROM messages m
...
// Notifications des demandes de rejoindre une équipe
        ...
        <div class="container container-fluid" style="padding: 0.5rem">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link lato16 <?= ($this_page == 'index.php') ? 'active' : '' ?>" href="<?= ($this_page == 'index.php') ? 'index.php' : '../index.php' ?>" style="color: white; margin-right:1.5rem; margin-left:1.5rem;">Accueil</a>
                    <a class="nav-link lato16 <?= ($this_page == 'magasin_main.php') ? 'active' : '' ?>" href="<?= ($this_page == 'index.php') ? 'magasin/magasin_main.php' : '../magasin/magasin_main.php' ?>" style="color: white;margin-right:1.5rem;">Magasin</a>
                    <a class="nav-link lato16 <?= ($this_page == 'tournois_main.php') ? 'active' : '' ?>" href="<?= ($this_page == 'index.php') ? 'tournois/tournois_main.php' : '../tournois/tournois_main.php' ?>" style="color: white;margin-right:1.5rem;">Tournois</a>
                    <a class="nav-link lato16 <?= ($this_page == 'communaute_main.php') ? 'active' : '' ?>" href="<?= ($this_page == 'index.php') ? 'communaute/communaute_main.php' : '../communaute/communaute_main.php' ?>" style="color: white;margin-right:1.5rem;">Communauté</a>
                    <a class="nav-link lato16 <?= ($this_page == 'actualite_main.php') ? 'active' : '' ?>" href="<?= ($this_page == 'index.php') ? 'actualite/actualite_main.php' : '../actualite/actualite_main.php' ?>" style="color: white;margin-right:1.5rem;">Actualités</a>
                    <a class="nav-link lato16 <?= ($this_page == 'forum_main.php') ? 'active' : '' ?>" href="<?= ($this_page == 'index.php') ? 'forum/forum_main.php' : '../forum/forum_main.php' ?>" style="color: white;">Forum</a>
                </div>
                            ...
                            <?php if ($notificationCountTeams > 0): ?>
                                <?php foreach ($teamRequests as $request): ?>
                                    <li class="dropdown-item d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="btn-group">
                                            <form action="/PA/team/accept_team_request.php" method="POST" style="display: inline;">
