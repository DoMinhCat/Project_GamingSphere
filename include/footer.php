<footer class="footer-enhanced pb-4 pt-5">
    <div class="container">
        <div class="row row-cols-1 row-cols-md-4 g-4 mb-4">
            <div class="col">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="py-2">
                        <a href="#" class="footer-link">Notre Équipe</a>
                    </li>
                    <li class="py-2">
            ...
            <div class="col">
                <h5 class="footer-heading">Aide</h5>
                <ul class="list-unstyled">
                    <li class="py-2">
                        <a href="#" class="footer-link">FAQ</a>
                    </li>
                    <li class="py-2">
                        <a href="#" class="footer-link">Guide d'Achat</a>
                    </li>
                    <li class="py-2">
            ...
            <div class="col">
                <h5 class="footer-heading">Informations Légales</h5>
                <ul class="list-unstyled">
                    <li class="py-2">
        ...
        <div class="newsletter-section p-4 mb-4">
