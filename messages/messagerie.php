            ...
            <div class="list-group">
                <?php foreach ($conversations as $conversation): ?>
                    <a href="<?= conversation . '?user=' . $conversation['id_utilisateurs'] ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                        <img src="../profil/<?= htmlspecialchars($conversation['photo_profil'] ?: 'uploads/profiles_pictures/default_profile_img.jpg') ?>" alt="Profil" class="rounded-circle me-3" width="50" height="50">
