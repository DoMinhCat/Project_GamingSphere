                ...
                <div class="list-group">
                    <?php foreach ($friends as $friend): ?>
                        <label class="list-group-item d-flex align-items-center">
                            ...
                            <img src="/profil/<?= ($friend['photo_profil'] ? htmlspecialchars($friend['photo_profil']) : 'uploads/profiles_pictures/default_profile_img.jpg') ?>" alt="Profil" class="rounded-circle me-3" width="50" height="50">
