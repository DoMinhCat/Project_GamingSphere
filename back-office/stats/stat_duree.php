...
$site = round($total_site['total_site'] / 60, 2);
...
$total = $category . ': ' . round($page_duree_value, 2);
...
$page_most = round($most_visited['category'], 2);
...
$page_least = round($least_visited['category'], 2);
...
$user_least = round($least_user['email'], 2);
...
$user_most = round($most_user['email'], 2);
