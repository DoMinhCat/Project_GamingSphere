...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        if (!$annonce) {
            header('Location: ' . forum_support_back . '?error=id_invalid');
            exit();
        }
...
<html lang="fr">
<?php
$title = 'Modifier sujet Support';
require('../../head.php');
?>

<body>
    <?php
    $page = forum_support_back;
    include('../../navbar.php');
    ?>
    <main class="container mb-5">
        ...
        <h1 class="text-center mt-5 mb-4">Modifier le sujet - Support</h1>
        <?php if (isset($annonce)): ?>
            <form action="update.php" method="POST" class="p-4 border rounded shadow-sm bg-light">
                ...
                <div class="text-center">
                    ...
                    <a href="<?= forum_support_back ?>" class="btn btn-secondary">Retour</a>
                </div>
            </form>
        <?php else: ?>
